...
[Gocloak](https://github.com/Nerzal/gocloak) is a full-featured Go client library for the [Keycloak](https://www.keycloak.org/) REST API. Keycloak is an open-source Identity and Access Management (IAM) solution widely used to secure applications with features such as Single Sign-On (SSO), OAuth 2.0, and OpenID Connect (OIDC).
...
Dudes of Wizardry — Ludum Dare 44 submission
{{< /youtube >}}
...
On a small tropical island a raccoon washes ashore. Surrounded by strange animals he has never seen before, he must survive the dangers ahead. Can you make friends with the island's inhabitants and help the raccoon pass the tests that await him?
...
Book of the Dread — Ludum Dare 48 submission
{{< /youtube >}}

[Play on itch.io](https://nerzal.itch.io/book-of-the-dread) · *Made with Wr4thon, Welverin*
...
Sir Blackmoon's Nightmare — Ludum Dare 50 submission
{{< /youtube >}}
